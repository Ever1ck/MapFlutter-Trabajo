...
class MapUiPage extends MainPage {
  MapUiPage() : super(const Icon(Icons.map), 'Interfaz de Usuario');
...
class MapUiBodyState extends State<MapUiBody> {
  ...
  Widget _doubleClickToZoomToggler() {
    final stateInfo = _doubleClickToZoomEnabled == null
        ...
        : _doubleClickToZoomEnabled!
            ...
            : 'enable';
    return TextButton(
      child: Text('$stateInfo doble click para hacer zoom'),
      onPressed: () {
        setState(() {
  ...
  Widget _visibleRegionGetter() {
    return TextButton(
      child: Text('obtener la región actualmente visible'),
      onPressed: () async {
